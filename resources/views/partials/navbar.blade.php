        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.return.request', auth()->user()->id) }}">
                            <i class="fas fa-undo-alt"></i> Request Pengembalian
                        </a>
                    </li>
                @endauth
            </ul>
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                            @if(auth()->user()->anggota && auth()->user()->anggota->foto)
                                <img src="{{ asset('avatars/' . auth()->user()->anggota->foto) }}" 
